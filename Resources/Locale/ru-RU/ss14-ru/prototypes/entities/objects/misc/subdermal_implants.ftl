...
ent-StomachImplant = имплант Безразмерный Желудок™
    .desc = Этот имплант позволяет использовать желудок в качестве хранилища для любых объектов. Приписка мелким шрифтом: "Безразмерность является рекламным слоганом и не гарантируется производителем, шприцы для кормления в комплект не входят".
